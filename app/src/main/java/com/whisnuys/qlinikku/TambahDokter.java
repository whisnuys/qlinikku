...
//        });
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        createAppointments(dokter);
                        Calendar d = Calendar.getInstance();
                        d.add(Calendar.DAY_OF_MONTH, 6);
                        dokter.setLastAutoGeneratedApptDate(d.getTime());
                    }
                });
            }
    ...
    private void createAppointments(Dokter dokter){
        Calendar c = Calendar.getInstance();
        for (int i = 0; i < 7; i++) { //Generating 1 week's worth of appts.
            Appointment.generateAvailableAppointmentsForOneDoctor(dokter, c.getTime());
