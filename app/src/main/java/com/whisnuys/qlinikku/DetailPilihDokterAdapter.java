...
public class DetailPilihDokterAdapter extends SectionedRecyclerViewAdapter<DetailPilihDokterAdapter.ViewHolder> {
    Activity activity;
    ...
    public void onBindViewHolder(ViewHolder holder, int section, int relativePosition, int absolutePosition) {
        ...
        holder.textView.setOnClickListener(v -> {
            if (docTimings.contains(sItem)) {
                ...
                Toast.makeText(activity, "Mohon pilih waktu yang masih ada", Toast.LENGTH_SHORT).show();
            }
