...
public class EditDataPasien extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_namaLengkap = findViewById(R.id.new_et_namalengkap);
        et_nik = findViewById(R.id.new_et_nik);
        et_tgllahir = findViewById(R.id.new_et_tgllahir);
        et_alamat = findViewById(R.id.new_et_alamat);
        et_nohp = findViewById(R.id.new_et_noHP);
        et_email = findViewById(R.id.new_et_email);
        et_password = findViewById(R.id.new_et_password);
        et_role = findViewById(R.id.new_et_role);
        ...
        imgAvatar = findViewById(R.id.new_img_avatar_pasien);
        btnTglLahir = findViewById(R.id.new_btn_tgllahir);
        btnSimpan = findViewById(R.id.btn_editpasien);
        btnUbahFoto = findViewById(R.id.fab_avatar_pasien);
        progressBar = findViewById(R.id.progressbar_editpasien);
        ...
        btnTglLahir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(EditDataPasien.this, R.style.DialogTheme,new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                if(isEmpty(namaLengkap)){
                    ...
                    uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(EditDataPasien.this, "Update Gagal", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void getData() {
        ...
        DatabaseReference dbF = FirebaseDatabase.getInstance().getReference("Users").child(pasienID);
        ...
        dbF.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(isEmpty(gambar_avatar)){
                    ...
                    Glide.with(EditDataPasien.this).load(gambar_avatar).into(imgAvatar);
                }

                listJK = new String[]{"Laki-laki", "Perempuan"};
                ArrayAdapter<String> adapter = new ArrayAdapter<>(EditDataPasien.this, android.R.layout.simple_spinner_dropdown_item, listJK);
...
//        });
        ...
        dbF.child("gambar").setValue(setPasien.getGambar()).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                et_email.setText("");
                et_idPasien.setText("");
                Toast.makeText(EditDataPasien.this, "Update Berhasil", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(EditDataPasien.this, ListDataPasien.class));
                finish();
            }
        });
    ...
    public void editDataPasienBackToList(View view) {
